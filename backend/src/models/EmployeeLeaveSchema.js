...
const EmployeeLeaveSchema = new mongoose.Schema({
	...
	leaveType: { type: String, enum: ["sick", "casual", "earned", "unpaid", "fop", "lop", "short_leave"], required: true },
	reason: { type: String, required: true, trim: true },
	remarks: { type: String, default: "" },
	startDate: { type: Date, required: true },
	endDate: { type: Date, required: true },
	durationType: { type: String, enum: ["full_day", "half_day", "multiple_days", "short_leave"], default: "multiple_days" },
	totalDays: { type: Number, required: true, min: 0.25 },
